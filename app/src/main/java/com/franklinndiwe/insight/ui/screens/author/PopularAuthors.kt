...
fun PopularAuthors(
    ...
    navigateBack: unit,
    popularAuthorsViewModel: PopularAuthorsViewModel = viewModel(factory = AppViewModelProvider.Factory),
) {
    val authorScreenImpl = popularAuthorsViewModel.authorScreenImpl
    ...
    ReusableAuthorScreen(
        ...
        authors = authorScreenImpl.authorUtils.getPopularAuthors(sortOrder),
        setting = setting,
        sortOrder = sortOrder,
